...
export interface TempVaultFixedContractInterface extends utils.Interface {
  functions: {
...
export interface TempVaultFixedContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TempVaultFixedContractInterface;
